...
export default function HealthCentersMap() {
  const centers = [
    { name: 'PHC Nashik', type: 'Primary Health Center', dist: '1.2 km', services: 'OPD, Immunization, Lab', time: '9 AM - 4 PM', beds: 6, emergency: false },
    ...
    { name: 'District Hospital Nashik', type: 'District Hospital', dist: '4.5 km', services: 'Full Services, Specialist OPD', time: '24/7', beds: 200, emergency: true },
        ...
        <div style={{ flex: '1 1 65%', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div className="map-placeholder" style={{ height: '500px', margin: 0 }}>
            ...
            <div style={{ position: 'absolute', top: '40%', left: '45%', textAlign: 'center' }}>
              ...
              <div style={{ background: 'var(--surface)', fontSize: '12px', padding: '2px 6px', borderRadius: '4px', marginTop: '4px', color: 'var(--text-primary)' }}>PHC Nashik</div>
            </div>
            ...
            <div style={{ position: 'absolute', top: '16px', left: '16px', background: 'var(--surface-light)', padding: '16px', borderRadius: '12px', border: '1px solid var(--border-subtle)', backdropFilter: 'blur(12px)', width: '300px' }}>
              ...
              <div className="form-group" style={{ marginBottom: '8px' }}>
                <input type="text" className="form-input" style={{ padding: '8px' }} defaultValue="Current Location (Nashik)" />
              </div>
              <div className="form-group" style={{ marginBottom: '12px' }}>
                <select className="form-input" style={{ padding: '8px' }}>
                  <option>Select Destination Center...</option>
                  <option>District Hospital Nashik</option>
                  <option>PHC Nashik</option>
                </select>
              </div>
